...
struct TabBar: View {
    ...
    var body: some View {
        VStack {
            ...
            .shadow(color: Color.accentColor.opacity(0.3), radius: 20, x: 0, y: 20)
            .overlay(
...
var tabItems = [
    ...
    TabItem(icon: RiveViewModel(fileName: "icons", stateMachineName: "CHAT_Interactivity", artboardName: "CHAT"), tab: .connect),
